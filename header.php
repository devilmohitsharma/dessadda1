...
<head>
    ...
    <?php }else{ ?>
        <title>DESIADDA_EcoMMRECE</title>
    <?php } ?>
    <!-- Bootstrap -->
...
<body>
    <div style="background-color:blue"><h1 style="color:black;font-size:46px, text-align:center,margin-left: 30px,padding-left: 30%;; " >WELCOME TO DESI ADDA SUPER MARKET</h1></div>
